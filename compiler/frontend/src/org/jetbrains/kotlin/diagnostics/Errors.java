...
public interface Errors {
    ...
    DiagnosticFactory3<PsiElement, ClassDescriptor, ClassDescriptor, MemberDescriptor> SUPER_CLASS_HAS_INVISIBLE_ABSTRACT_MEMBER = DiagnosticFactory3.create(WARNING);
